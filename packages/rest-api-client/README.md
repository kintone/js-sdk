...
| clientCertAuth.pfx         | [Blob](https://developer.mozilla.org/en-US/docs/Web/API/Blob) |                             | The [client certificate file](https://jp.cybozu.help/general/en/user/list_access/remote/webbrowser.html). Required, unless you specify `pfxFilePath`.                                                                        |
