...
| proxy                      |                        Object or `false`                         |                             | **This parameter is available only in Node.js environment.**<br />If you use a proxy, please specify its configuration.<br>To disable proxy ignoring environment variables, please specify `false`.                                                                                                                                                          |
