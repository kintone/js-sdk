...
| proxy                      |                              Object                              |                             | If you use a proxy, please specify its configuration.                                                                                                                                                                        |
| proxy.host                 |                              String                              |                             | The host (e.g. `localhost`) of the proxy server.                                                                                                                                                                             |
| proxy.port                 |                              Number                              |                             | The port (e.g. `8000`) of the proxy server.                                                                                                                                                                                  |
