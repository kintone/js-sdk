...
| guests[].locale           | String |          | The language settings of the Guest user.<br/>- <strong>auto</strong>: Use web browser settings.<br />- <strong>en</strong>: English<br />- <strong>zh</strong>: Chinese<br />- <strong>zh-TW</strong>: Traditional Chinese<br />- <strong>ja</strong>: Japanese<br />- <strong>es</strong>: Spanish<br />- <strong>pt-BR</strong>: Portuguese (Brazil)<br />- <strong>th</strong>: Thai<br />- <strong>ms-MY</strong>: Malay (Malaysia)<br />If ignored, <strong>auto</strong> will be set. |
