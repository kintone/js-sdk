...
`;
  ...
  it("should convert kintone records to csv string correctly when SUBTABLE included", () => {
    const expectedCsv = `"*","__index__","recordNumber","updatedTime","dropDown","creator","subTable.id","subTable.subTableText","subTable.subTableCheckbox","modifier","richText","singleLineText","number","radioButton","multiLineText","createdTime","checkBox","calc","multiSelect"
