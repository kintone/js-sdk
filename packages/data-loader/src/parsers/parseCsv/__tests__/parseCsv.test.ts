...
`;
  ...
  it("should convert subtable included csv string to JSON correctly", () => {
    const csv = `"*","recordNumber","updatedTime","dropDown","creator","subTable.id","subTable.subTableText","subTable.subTableCheckbox","modifier","richText","singleLineText","number","radioButton","multiLineText","createdTime","checkBox","calc","multiSelect"
