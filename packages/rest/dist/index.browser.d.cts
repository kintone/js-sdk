import { ClientOptions, Client, MaybeOptionalInit, FetchResponse } from 'openapi-fetch';
import { Agent } from 'undici';
import { MediaType, HttpMethod, PathsWithMethod } from 'openapi-typescript-helpers';
...
type AuthOption = ApiTokenAuth | PasswordAuth | SessionAuth | OAuthTokenAuth;
...
type KintoneClientOptions = ClientOptions & {
    auth?: AuthOption;
...
declare const createClient: (clientOptions: KintoneClientOptions) => Client<paths>;
...
type CreateRequestIteratorMethod<Paths extends Record<string, Record<HttpMethod, {}>>, Media extends MediaType> = <Method extends HttpMethod, Path extends PathsWithMethod<Paths, Method>, Init extends MaybeOptionalInit<Paths[Path], Method>>(method: Method, url: Path, handleRequest: (previousInit: InitParam<Init>, previousResult: FetchResponse<Paths[Path][Method], Init, Media> | null) => InitParam<Init>, hasNext: (init: InitParam<Init>, response: FetchResponse<Paths[Path][Method], Init, Media> | null) => boolean, init: InitParam<Init>) => AsyncGenerator<FetchResponse<Paths[Path][Method], Init, Media>>;
...
declare const iterator: <Paths extends {} = any, Media extends MediaType = any>(client: Client<Paths, Media>) => ClientIterator<Paths, Media>;
