export {};
import { Kintone } from "./kintone.js";

export declare const kintone: Kintone;
declare global {
...
//   var kintone: {
//     api: {
//       (): (pathOrUrl: string, method: string, params: any) => Promise<any>;
...
//       grandchild: (input: number) => number;
//     };
//   };
// }
...
//     //   handler: (event: any) => any
//     // ): boolean;
//     // function off(eventType: string | string[]): boolean;
//     // function off(): boolean;
//     export { events } from "./events.d.ts";
//   }
//
//   namespace kintone {
//     var api: {
